...
使用DAGAN合成图像+原始训练集数据训练分类器

关键点:
- 原始训练集 + DAGAN合成图像 = 增强训练集
- 验证集和测试集使用原始数据（不增强）
- 严格避免数据泄露
- 合成图像来自 shared/dagan/outputs/synthetic_images
"""
...
def get_dataloaders(
    ...
    print(f"  - 合成数据集: {len(synthetic_dataset)} 张（带传统增强）")
...
if __name__ == '__main__':
    ...
    # 假设数据目录
    real_data_dir = '/Users/koolei/Desktop/hust-bysj/code/data/BUSI'
    synthetic_data_dir = 'outputs/synthetic_images'
