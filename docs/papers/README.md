...
1. **必读**：Al-Dhabyani 2020（数据集出处）
2. **必读**：Al-Dhabyani 2019（性能基准 99%）
3. **推荐**：arXiv 2025（ResNet-18 直接对比）
4. **推荐**：EfficientNet-B7 2024（EfficientNet 参考）
5. **可选**：Jabeen 2024（ResNet 改进思路）
